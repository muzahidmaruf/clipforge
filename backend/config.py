...
# Ollama Cloud uses OpenAI-compatible endpoint: https://ollama.com/v1/chat/completions
...
OLLAMA_CLOUD_TIMEOUT = int(os.getenv("OLLAMA_CLOUD_TIMEOUT", "180"))  # Increased default timeout for analysis
